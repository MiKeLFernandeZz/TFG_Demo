...
def TFG_Demo_dag():
    ...
    get_dataset_result = get_dataset_task()
    train_GPU_result = train_GPU_task(get_dataset_result)
    train_CPU_result = train_CPU_task(get_dataset_result)
    redis_task_result = redis_clean_task([get_dataset_result])
    
    # Define the order of the pipeline
    get_dataset_result >> [train_GPU_result, train_CPU_result] >> redis_task_result
# Call the DAG 
TFG_Demo_dag()